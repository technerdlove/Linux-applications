...
$servers->setValue('server','name','technerdlove openLDAP Server');
...
$servers->setValue('server','base',array('dc=technerdlove,dc=local'));
...
$servers->setValue('login','bind_id','cn=Manager,dc=technerdlove,dc=local');
